...
// +kubebuilder:deprecatedversion:warning="networking.cfargotunnel.com/v1alpha1 ClusterTunnel is deprecated, see https://github.com/wiley/cloudflare-operator/tree/v0.13.0/docs/migration/crd/v1alpha2.md for migrating to v1alpha2"
