...
1. Create a kustomization.yaml in your repository that looks like
   ...
   resources:
     ...
     - https://github.com/wiley/cloudflare-operator.git/config/default?ref=0.13.3
   ```
...
```bash
kubectl apply -k 'https://github.com/wiley/cloudflare-operator.git//config/default?ref=0.13.3'
```
