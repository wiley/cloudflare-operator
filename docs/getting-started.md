...
1. Find the [latest tag for cloudflare-operator.](https://github.com/wiley/cloudflare-operator/tags)
1. Create a kustomization.yaml in your repository that looks like
   ...
   resources:
     ...
     - https://github.com/wiley/cloudflare-operator.git/config/default?ref=v0.13.1
   ```
...
[You can find the latest tag here](https://github.com/wiley/cloudflare-operator/tags)

```bash
kubectl apply -k 'https://github.com/wiley/cloudflare-operator.git//config/default?ref=v0.13.1'
```
...
```bash
kubectl apply -k 'https://github.com/wiley/cloudflare-operator.git/config/default?ref=main'
kubectl apply -k 'https://github.com/wiley/cloudflare-operator/config/default'
```
